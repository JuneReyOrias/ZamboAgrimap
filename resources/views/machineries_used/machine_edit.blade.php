...
<div class="page-content">
  ...
  <div class="row">
    <div class="col-md-12 grid-margin">
      ...
      <br>
          ...
          <h6 class="card-title"><span>IV.</span>Update machineries Used</h6>

          <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A.</p><br>
       
         
         
         <form id="myForm" action{{url('updateMachineries')}} method="post"  >
            @csrf
            <div class="row mb-3">
              ...
              <div >
                ...
                <div class="col-md-3 mb-3">    
                  ...
                  <select class="form-control placeholder-text" name="personal_informations_id" aria-label="personal_informations_id">
                    ...
                    <option value="{{ $machineries->personal_informations_id }}">{{ $machineries->personalInformation->first_name.' '. $machineries->personalInformation->last_name}}</option>
                ...
                <div class="col-md-3 mb-3">    
                  ...
                  <select class="form-control mb-4 mb-md-0" name="farm_profiles_id" aria-label="farm_profiles_id">
                    @if($machineries)
                    <option value="{{ $machineries->farm_profiles_id }}">{{ $machineries->farmprofile->tenurial_status }}</option>
                @else
              ...
              <div class="col-md-3 mb-3">
                ...
                <select class="form-control placeholder-text @error('plowing_machineries_used') is-invalid @enderror" name="plowing_machineries_used" id="selectPlowing" onchange="checkPlowing()" aria-label="label select e">
                  <option value="{{$machineries->plowing_machineries_used}}">{{$machineries->plowing_machineries_used}}</option>
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <select class="form-control placeholder-text @error('plo_ownership_status') is-invalid @enderror" name="plo_ownership_status" id="selectPlowingStatus" onchange="checkPlowingStatus()" aria-label="label select e">
                    <option value= "{{$machineries->plo_ownership_status}}">{{$machineries->plo_ownership_status}}</option>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('no_of_plowing') is-invalid @enderror"value= "{{$machineries->no_of_plowing}}" name="no_of_plowing" id="noPlowing" placeholder="Enter no. of plowing" value="{{ old('no_of_plowing') }}" >
                @error('no_of_plowing')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('cost_per_plowing') is-invalid @enderror"value= "{{$machineries->cost_per_plowing}}" name="cost_per_plowing" id="plowingperCostInput" placeholder="Enter plowing cost" value="{{ old('cost_per_plowing') }}" >
            ...
            @enderror
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('plowing_cost') is-invalid @enderror"value= "{{$machineries->plowing_cost}}" name="plowing_cost" id="plowingCostInput" placeholder="Enter plowing cost" value="{{ old('plowing_cost') }}" >
                @error('plowing_cost')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">
                ...
                <select class="form-control placeholder-text @error('harrowing_machineries_used') is-invalid @enderror" name="harrowing_machineries_used" id="selectHarrowing" onchange="checkHarrowing()" aria-label="label select e">
                  <option value= "{{$machineries->harrowing_machineries_used}}">{{$machineries->harrowing_machineries_used}}</option>
           ...
           <div class="col-md-3 mb-3" id="HarrowingmachineriesInput" style="display: none;">
            ...
            @enderror
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <select class="form-control placeholder-text @error('harro_ownership_status') is-invalid @enderror" name="harro_ownership_status" id="selectStatus" onchange="checkStatus()" aria-label="label select e">
                    <option value= "{{$machineries->harro_ownership_status}}">{{$machineries->harro_ownership_status}}</option>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('no_of_harrowing') is-invalid @enderror" value= "{{$machineries->no_of_harrowing}}" name="no_of_harrowing" id="noHarrowing" placeholder="Enter no. of harrowing" value="{{ old('no_of_harrowing') }}" >
            ...
            @enderror
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('cost_per_harrowing') is-invalid @enderror"value= "{{$machineries->cost_per_harrowing}}" name="cost_per_harrowing" id="costPerHarrowingInput" placeholder="Enter no. of harrowing">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('harrowing_cost') is-invalid @enderror"value= "{{$machineries->harrowing_cost}}" name="harrowing_cost" id="harrowingCostInput" placeholder="Enter harrowing cost">
               ...
               <div class="row mb-3">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <select class="form-control placeholder-text @error('harvesting_machineries_used') is-invalid @enderror" name="harvesting_machineries_used" id="selectHarvesting" onchange="checkHarvesting()" aria-label="label select e">
                    <option value= "{{$machineries->harvesting_machineries_used}}">{{$machineries->harvesting_machineries_used}}</option>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control placeholder-text @error('harvest_ownership_status') is-invalid @enderror" name="harvest_ownership_status" id="selectHarvestStatus" onchange="checkHarvestStatus()" aria-label="label select e">
                      <option value= "{{$machineries->harvest_ownership_status}}">{{$machineries->harvest_ownership_status}}</option>
    ...
    <input type="text" class="form-control placeholder-text @error('harvesting_cost') is-invalid @enderror"value= "{{$machineries->harvesting_cost}}" name="harvesting_cost" id="harvestingCostInputs" placeholder="Enter harvesting cost" value="{{ old('harvesting_cost') ? number_format(old('harvesting_cost'), 2) : '' }}" >
  ...
  <div class="col-md-3 mb-3">
    ...
    <select class="form-control placeholder-text @error('postharvest_machineries_used') is-invalid @enderror" name="postharvest_machineries_used" id="selectpostharvest" onchange="checkpostharvest()" aria-label="label select e">
      <option value= "{{$machineries->postharvest_machineries_used}}">{{$machineries->postharvest_machineries_used}}</option>
    ...
    <div class="col-md-3 mb-3">
      ...
      <select class="form-control placeholder-text @error('postharv_ownership_status') is-invalid @enderror" name="postharv_ownership_status" id="selectpostHarvestStatus" onchange="checkpostHarvestStatus()" aria-label="label select e">
        <option value= "{{$machineries->postharv_ownership_status}}">{{$machineries->postharv_ownership_status}}</option>
  ...
  <div class="col-md-3 mb-3">
    ...
    <input type="text" class="form-control placeholder-text @error('post_harvest_cost') is-invalid @enderror"value= "{{$machineries->post_harvest_cost}}" name="post_harvest_cost" id="postHarvestCostInput" placeholder="Enter of post harvest cost" value="{{ old('post_harvest_cost') }}" >
