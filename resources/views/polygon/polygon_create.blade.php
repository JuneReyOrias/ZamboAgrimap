    ...
    <div class="col-md-12 grid-margin">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <h6 class="card-title"><span>I.</span>Create Polygon</h6>
         ...
         {{-- <p class="text-muted mb-3">Read the <a href="https://github.com/RobinHerbots/Inputmask" target="_blank"> Official Inputmask Documentation </a>for a full list of instructions and other options.</p> --}}
          <form action{{url('polygons')}} method="post">
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating mb-4 mb-md-0">
                <input  class="form-control mb-4 mb-md-0" name="verone_latitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
            ...
            <div class="col-md-3">
              <div class="form-floating mb-4 mb-md-0">
              <input  class="form-control mb-4 mb-md-0" name="verone_longitude" placeholder="MiddleName" type="text" aria-label="MiddleName"id="floatingInput">
              <label for="floatingInput" >Point 1 Longitude:</label>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-floating mb-4 mb-md-0">
            <input  class="form-control mb-4 mb-md-0" name="vertwo_latitude" placeholder="Lastname" type="text" aria-label="LastName"id="floatingInput">
        ...
        {{-- <div class="col-md-3">
          ...
          <label for="floatingInput" >Longitude:</label>
              ...
              <div class="col-md-3">
                  ...
                  <div class="form-floating mb-4 mb-md-0">
                  <input  class="form-control mb-4 mb-md-0" name="vertwo_longitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
              ...
              <div class="col-md-3">
                <div class="form-floating mb-4 mb-md-0">
                <input  class="form-control mb-4 mb-md-0" name="verthree_latitude" placeholder="MiddleName" type="text" aria-label="MiddleName"id="floatingInput">
          ...
          <div class="col-md-3">
            <div class="form-floating mb-4 mb-md-0">
            <input  class="form-control mb-4 mb-md-0"  name="verthree_longitude"  placeholder="Extension Name" type="text" aria-label="ExtensionName"id="floatingInput">
        ...
        <div class="col-md-3">
            ...
            <div class="form-floating mb-4 mb-md-0">
            <input  class="form-control mb-4 mb-md-0" name="vertfour_latitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
            <label for="floatingInput" >Point 4 Latitude:</label>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-floating mb-4 mb-md-0">
                        <input  class="form-control mb-4 mb-md-0" name="vertfour_longitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
                    ...
                    <div class="col-md-3">
                      <div class="form-floating mb-4 mb-md-0">
                      <input  class="form-control mb-4 mb-md-0" name="verfive_latitude" placeholder="MiddleName" type="text" aria-label="MiddleName"id="floatingInput">
                ...
                <div class="col-md-3">
                  <div class="form-floating mb-4 mb-md-0">
                  <input  class="form-control mb-4 mb-md-0"  name="verfive_longitude"  placeholder="Extension Name" type="text" aria-label="ExtensionName"id="floatingInput">
                  <label for="floatingInput" >Point 5 Longitude:</label>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-floating mb-4 mb-md-0">
                <input  class="form-control mb-4 mb-md-0"  name="versix_latitude"  placeholder="Extension Name" type="text" aria-label="ExtensionName"id="floatingInput">
                <label for="floatingInput" >Point 6:</label>
              </div>
            </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-floating mb-4 mb-md-0">
                            <input  class="form-control mb-4 mb-md-0" name="versix_longitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
                        ...
                        <div class="col-md-3">
                          <div class="form-floating mb-4 mb-md-0">
                          <input  class="form-control mb-4 mb-md-0" name="verseven_latitude" placeholder="MiddleName" type="text" aria-label="MiddleName"id="floatingInput">
                    ...
                    <div class="col-md-3">
                      <div class="form-floating mb-4 mb-md-0">
                      <input  class="form-control mb-4 mb-md-0"  name="verseven_longitude"  placeholder="Extension Name" type="text" aria-label="ExtensionName"id="floatingInput">
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="form-floating mb-4 mb-md-0">
                      <input  class="form-control mb-4 mb-md-0" name="vereight_latitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
                      <label for="floatingInput" >Point 8 Latitude:</label>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-floating mb-4 mb-md-0">
                                <input  class="form-control mb-4 mb-md-0" name="verteight_longitude" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
                        ...
                        <div class="col-md-3">
                          <div class="form-floating mb-4 mb-md-0">
                          <input  class="form-control mb-4 mb-md-0"  name="perimeter"  placeholder="Extension Name" type="text" aria-label="ExtensionName"id="floatingInput">
                          <label for="floatingInput" >Perimeter:</label>
                        </div>
                      </div>
