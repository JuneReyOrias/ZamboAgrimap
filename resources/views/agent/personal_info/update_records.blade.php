        ...
        <h6 class="card-title">Rice Survey Form Update</h6>
          ...
          $agent= App\Models\User::find($id);
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('first_name') is-invalid @enderror" name="first_name" value="{{$personlinformation->first_name}}"id="first_name" placeholder="First name" value="{{ old('first_name') }}">
                @error('first_name')
            ...
            @enderror
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('middle_name') is-invalid @enderror" name="middle_name" value="{{$personlinformation->middle_name}}" id="middle_name" placeholder="Middle name"value="{{ old('middle_name') }}" >
                @error('middle_name')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('last_name') is-invalid @enderror" name="last_name" value="{{$personlinformation->last_name}}" id="last_name" placeholder="Last name" value="{{ old('last_name') }}" >
                @error('last_name')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('extension_name') is-invalid @enderror" name="extension_name" value="{{$personlinformation->extension_name}}" id="extension_name" placeholder="Extension name" value="{{ old('extension_name') }}" >
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('home_address') is-invalid @enderror"name="home_address"value="{{$personlinformation->home_address}}" id="home_address" placeholder="Home Address" value="{{ old('home_address') }}" >
              @error('home_address')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('contact_no') is-invalid @enderror" name="contact_no" value="{{$personlinformation->contact_no}}"id="contact_no" placeholder="Contact No." value="{{ old('contact_no') }}" >
              @error('contact_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('religion') is-invalid @enderror" value="{{$personlinformation->religion}}" name="religion" id="religion" placeholder="Religion" value="{{ old('religion') }}" >
              @error('religion')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
            ...
            <div class="col-md-3 mb-3">
              ...
              <input class="form-control placeholder-text @error('date_of_birth') is-invalid @enderror"
                     name="date_of_birth"value="{{$personlinformation->date_of_birth}}" id="datepicker" placeholder="Date of Birth"
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('place_of_birth') is-invalid @enderror"value="{{$personlinformation->place_of_birth}}" name="place_of_birth" id="validationCustom02" placeholder="Place of Birth"  value="{{ old('place_of_birth') }}" >
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('name_legal_spouse') is-invalid @enderror" value="{{$personlinformation->name_legal_spouse}}"name="name_legal_spouse" id="name_legal_spouse" placeholder="Name of Legal Spouse"  value="{{ old('name_legal_spouse') }}">
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <select class="form-control placeholder-text  @error('no_of_children') is-invalid @enderror"value="{{$personlinformation->no_of_children}}"name="no_of_children"id="validationCustom01" aria-label="Floating label select e">
                <option value="{{$personlinformation->no_of_children}}">{{$personlinformation->no_of_children}}</option>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('mothers_maiden_name') is-invalid @enderror"value="{{$personlinformation->mothers_maiden_name}}"name="mothers_maiden_name" id="mothers_maiden_name" placeholder="Mother's Maiden Name"  value="{{ old('mothers_maiden_name') }}">
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <select class="form-control placeholder-text  @error('highest_formal_education') is-invalid @enderror" name="highest_formal_education"id="validationCustom01" aria-label="Floating label select e">
                <option value="{{$personlinformation->highest_formal_education}}">{{$personlinformation->highest_formal_education}}</option>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('pwd_id_no') is-invalid @enderror"value="{{$personlinformation->pwd_id_no}}"name="pwd_id_no" id="pwd_id_no" placeholder="PWD ID No." value="{{ old('pwd_id_no') }}"  >
              @error('pwd_id_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <select class="form-control placeholder-text @error('id_type') is-invalid @enderror" name="id_type"id="validationCustom01" aria-label="Floating label select e">
                <option value="{{$personlinformation->id_type}}">{{$personlinformation->id_type}}</option>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('gov_id_no') is-invalid @enderror"value="{{$personlinformation->gov_id_no}}"name="gov_id_no" id="gov_id_no" placeholder="ID No."  value="{{ old('gov_id_no') }}">
              @error('gov_id_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('nameof_farmers_ass_org_coop') is-invalid @enderror"value="{{$personlinformation->nameof_farmers_ass_org_coop}}" id="validationCustom02"name="nameof_farmers_ass_org_coop" placeholder="if Yes please specify" value="{{ old('nameof_farmers_ass_org_coop') }}">
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('name_contact_person') is-invalid @enderror"value="{{$personlinformation->name_contact_person}}" id="name_contact_person"name="name_contact_person"  placeholder="Name of Contact Person"  value="{{ old('name_contact_person') }}">
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('cp_tel_no') is-invalid @enderror"value="{{$personlinformation->cp_tel_no}}" id="'cp_tel_no"name="cp_tel_no" placeholder="Celphone/Tel.no"  value="{{ old('cp_tel_no') }}" >
              @error('cp_tel_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
