  ...
  <div class="row">
    <div class="col-md-12 grid-margin">
      ...
      @endif
          ...
          <br>
          <h6 class="card-title"><span>I.</span> Update Personal Informations</h6>
<br><br>
          <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A.</p><br>
        
          <form id="surveyForm" action{{url('updateinfo')}} method="post">
            @csrf
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('first_name') is-invalid @enderror"value="{{ $personalinfos->first_name}}" name="first_name" id="validationCustom01" placeholder="First name" value="{{ old('first_name') }}">
                @error('first_name')
            ...
            @enderror
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('middle_name') is-invalid @enderror"value="{{ $personalinfos->middle_name}}" name="middle_name" id="validationCustom02" placeholder="Middle name"value="{{ old('middle_name') }}" >
                @error('middle_name')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control placeholder-text @error('last_name') is-invalid @enderror"value="{{ $personalinfos->last_name}}" name="last_name" id="validationCustom01" placeholder="Last name" value="{{ old('last_name') }}" >
                @error('last_name')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
        ...
        <div class="col-md-3 mb-3" id="barangayInput" style="{{ in_array($agri_district, ['ayala','vitali', 'culianan', 'tumaga', 'manicahan', 'curuan']) ? 'display: block;' : 'display: none;' }}">
          ...
          <select class="form-control" name="barangay" id="SelectBarangay">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('contact_no') is-invalid @enderror"value="{{$personalinfos->contact_no}}" name="contact_no"id="validationCustom02" placeholder="Contact No." value="{{ old('contact_no') }}" >
              @error('contact_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input class="form-control placeholder-text @error('date_of_birth') is-invalid @enderror"
                     name="date_of_birth" id="datepicker" placeholder="Date of Birth"value="{{ $personalinfos->date_of_birth}}"
...
{{-- 
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('mothers_maiden_name') is-invalid @enderror"value="{{ $personalinfos->mothers_maiden_name}}"name="mothers_maiden_name" id="validationCustom02" placeholder="Mother's Maiden Name"  value="{{ old('mothers_maiden_name') }}">
...
{{--             
          ...
          @enderror
                    ...
                    <div class="col-md-3 mb-3" id="YesInputSelected" style="display: none;">
                      ...
                      <input type="text" id="YesInputSelected" name="pwd_id_no" class="form-control @error('pwd_id_no') is-invalid @enderror"value="{{ $personalinfos->pwd_id_no}} placeholder="Enter pwdID no." value="{{ old('pwd_id_no') }}">
                      @error('pwd_id_no')
                      <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                    </div>
          ...
          @enderror
            ...
            {{-- add new form --}}
            <div class="col-md-3 mb-3" id="iDtypeSelected">
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3" id="idNoInput" >
              <label for="idNoInput">ID No.:</label>
              <input type="text" id="idNoInput" class="form-control placeholder-text @error('gov_id_no') is-invalid @enderror"value="{{ $personalinfos->gov_id_no}}"name="gov_id_no" id="validationCustom02" placeholder=" Enter ID No."  value="{{ old('gov_id_no') }}">
              @error('gov_id_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
          </div>
      ...
      @enderror
          ...
          @enderror
              ...
              <div class="col-md-3 mb-3" id="YesFarmersGroup" >
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('name_contact_person') is-invalid @enderror"value="{{ $personalinfos->name_contact_person}}" id="validationCustom01"name="name_contact_person"  placeholder="Name of Contact Person"  value="{{ old('name_contact_person') }}">
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('cp_tel_no') is-invalid @enderror"value="{{ $personalinfos->cp_tel_no}}" id="validationCustom02"name="cp_tel_no" placeholder="Celphone/Tel.no"  value="{{ old('cp_tel_no') }}" >
              @error('cp_tel_no')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
...
<div  class="d-grid gap-2 d-md-flex justify-content-md-end">
  <a href="{{ route('agent.personal_info.view_infor') }}" class="btn btn-success me-md-2 justify-content-md-start">Back</a>
