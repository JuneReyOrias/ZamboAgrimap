...
<div class="page-content">
  ...
  <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A.</p><br>
         ...
         <form id="surveyForm" action{{url('AddNewProduction')}} method="post" >
            @csrf
            <div>
  ...
  @enderror
      ...
      <div class="col-md-3 mb-3" id="PalayInput" style="display: none;">
        ...
        <input type="text" id="OthersInput" class="form-control placeholder-text @error('if_palay_milled_where') is-invalid @enderror"name="if_palay_milled_where" id="validationCustom02" placeholder=" palay milled where?"  value="{{ old('if_palay_milled_where') }}">
