        ...
        @endif
           ...
           <form  action{{url('AddNewProduction')}} method="post"  >
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-3">
                  ...
                  <input id="lastname" class="form-control mb-4 mb-md-0" name="seeds_typed_used" placeholder="" type="text" aria-label="seeds_typed_used"id="floatingInput">
          ...
          <div class="col-md-3">
            ...
            <label for="floatingInput" >  No. of fertilizer used in bags:</label>
              ...
              <div class="col-md-3">
                <div class="form-floating mb-4 mb-md-0">
                <input  class="form-control mb-4 mb-md-0" name="date_planted" placeholder="Lastname" type="text" aria-label="MiddlName"id="floatingInput">
          ...
          <div class="row mb-3">
            <div class="col-md-3">
              <div class="form-floating mb-4 mb-md-0">
              <input  class="form-control mb-4 mb-md-0" name="date_harvested" placeholder="Lastname" type="text" aria-label="MiddlName"id="floatingInput">
