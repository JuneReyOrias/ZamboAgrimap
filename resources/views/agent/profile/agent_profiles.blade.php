    ...
    <div class="d-none d-md-block col-md-4 col-xl-3 left-wrapper">
      <div class="card rounded">
        <div class="card-body">
          ...
          <div>
            <img class="wd-70 rounded-circle" id="Showimage" style="height:100px; width:130px;" src="/agentimages/{{$profileData->image}}"alt="profile">
            ...
            <div class="card-header">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="card-body">
                  ...
                  <form action{{url('updateAdmin')}} method="post" enctype="multipart/form-data"  class="forms-sample">
                 
                  @csrf
                 
                    <div class="mb-3">
                      <label for="exampleInputUsername1" name="name" class="form-label">Name</label>
                      <input type="text" class="form-control" name="firstname"  id="exampleInputUsername1" autocomplete="off"value="{{$profileData->name}}">
                    </div>
                    ...
                    <div class="mb-3">
                      <label for="exampleInputPassword1" name="agri_district" class="form-label">Agri District</label>
                      <input type="text" class="form-control"name="contact_no" id="agri_district" autocomplete="off" value="{{$profileData->agri_district}}">
                    </div>
                    <div class="mb-3">
                    ...
                    <img class="wd-70 rounded-circle" id="showImage"src="/agentimages/{{$profileData->image}}" alt="profile">
                    </div>
