  ...
  <div class="row">
    <div class="col-md-12 grid-margin">
      ...
      @endif
        ...
        <h5 class="card-title"><span>e.</span> Update Transport</h5>
        <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A.</p><br>
       
         
         <form id="myForm" action{{url('TransportDataupdate')}} method="post">
            @csrf
            <div >
            ...
            <div class="row mb-3">
              <h2 class="card-title"><span></span>Update Transport info:</h2>
