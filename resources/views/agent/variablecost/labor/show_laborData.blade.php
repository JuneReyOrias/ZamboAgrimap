                ...
                <table class="table table table-info">
                    ...
                    @foreach($labors as $labor)
                        <tr class="table-light">
                            ...
                            <td>
                                  <a href="{{route('agent.variablecost.labor.formEdit_labors',  $labor->id)}}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
