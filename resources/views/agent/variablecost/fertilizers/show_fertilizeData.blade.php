                ...
                <table class="table table table-info">
                    ...
                    @foreach($fertilizers as $fertilizer)
                        <tr class="table-light">
                            ...
                            <td>
                                  <a href="{{route('agent.variablecost.fertilizers.formsEdit_fertilizeData',  $fertilizer->id)}}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
