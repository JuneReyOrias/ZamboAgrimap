                ...
                @foreach($seeds as $seed)
                    <tr class="table-light">
                        ...
                        <td>
                             ...
                             <a href="{{route('agent.variablecost.seed.seeds_form_edit',  $seed->id)}}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                
                             <form  action="{{ route('agent.variablecost.seed.delete', $seed->id) }}"method="post" accept-charset="UTF-8" style="display:inline">
                            @csrf
                                @method('DELETE')
