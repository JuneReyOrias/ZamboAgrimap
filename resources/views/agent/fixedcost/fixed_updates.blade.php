...
<div class="page-content">
  ...
  <div class="row">
    <div class="col-md-12 grid-margin">
      ...
      <br>
          <h6 class="card-title"><span>III.</span>Update Fixed Cost</h6>
          <p class="text-success">Provide clear and concise responses to each section, ensuring accuracy and relevance. If certain information is not applicable, write N/A.</p><br>
       

         <form id="myForm"  action{{url('updateFixedcosts')}} method="post"  >
            @csrf
            <div >
             ...
             <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">    
                ...
                <select class="form-control placeholder-text" name="personal_informations_id" aria-label="personal_informations_id">
                  @if($fixedcosts)
                  <option value="{{ $fixedcosts->personal_informations_id }}">{{ $fixedcosts->personalInformation->last_name }}</option>
              @else
              ...
              <div class="col-md-3 mb-3">    
                ...
                <select class="form-control mb-4 mb-md-0" name="farm_profiles_id" aria-label="farm_profiles_id">
                    @if($fixedcosts)
                        <option value="{{ $fixedcosts->farm_profiles_id }}">{{ $fixedcosts->farmprofile->tenurial_status }}</option>
                    @else
                        <option value="" disabled>No farm profile available</option>
                    @endif
                </select>
              ...
              <div class="col-md-3 mb-3">
                ...
                <select class="form-control placeholder-text @error('particular') is-invalid @enderror" name="particular" id="selectParticular" onchange="checkParticular()" aria-label="label select e">
                  <option value="{{$fixedcosts->particular}}">{{$fixedcosts->particular}}</option>
          ...
          @enderror
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control placeholder-text @error('total_amount') is-invalid @enderror"value="{{$fixedcosts->total_amount}}" name="total_amount" id="total_amount" placeholder="Enter total amount" value="{{ old('total_amount') }}" >
              @error('total_amount')
              <div class="invalid-feedback">{{ $message }}</div>
          @enderror
            </div>
