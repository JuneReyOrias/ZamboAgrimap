...
<h4 class="mb-3 mb-md-0">Manicahan Rice Farmers Info</h4>
        ...
        <div class="table-responsive tab">
            <table  class="table table-bordered datatable">
                ...
                <tbody>
                    ...
                    {{-- <a href="{{ route('agent.manicahan.show_personal_info', ['id' => $personalinformation->id]) }}" class="btn btn-primary">Show Details</a> --}}
    ...
    <div id="farm_profile_section" style="display: none;">
        ...
        <div class="table-responsive tab">
            <table  class="table table-bordered datatable">
                ...
                <tbody>
                    @foreach($FarmersData->where('agri_district','manicahan') as $farmers)
                        <tr class="table-light">
