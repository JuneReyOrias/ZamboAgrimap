...
<br>
<h4 class="mb-3 mb-md-0">Ayala Rice Farmers Info</h4>
        ...
        <div class="table-responsive tab">
            <table  class="table table-bordered datatable">
                ...
                <td>
                    ...
                    <a href="{{ route('agent.ayala.show_personal_info', ['id' => $personalinformation->id]) }}" class="btn btn-primary">Show Details</a>
    ...
    <div id="farm_profile_section" style="display: none;">
        ...
        <div class="table-responsive tab">
            <table  class="table table-bordered datatable">
                ...
                <tbody>
                    @foreach($FarmersData->where('agri_district','ayala') as $farmers)
                        <tr class="table-light">
