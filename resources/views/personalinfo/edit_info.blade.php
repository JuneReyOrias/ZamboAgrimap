...
<br><br>
          ...
          <form id="surveyForm" action{{url('PersonalInfoUpdate')}} method="post">
            @csrf
...
<div  class="d-grid gap-2 d-md-flex justify-content-md-end">
  <a href="{{ route('personalinfo.create') }}" class="btn btn-success me-md-2 justify-content-md-start">Back</a>
