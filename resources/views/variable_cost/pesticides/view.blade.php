                ...
                @foreach($pesticides as $pesticide)
                    <tr class="table-light">
                        ...
                        <td>
                             ...
                             <a href="{{route('variable_cost.pesticides.pest_edit',  $pesticide->id)}}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
