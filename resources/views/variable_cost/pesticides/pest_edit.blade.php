...
<div class="page-content">
    ...
    <div class="row">
      <div class="col-md-12 grid-margin">
        ...
        @endif
           ...
           <form action{{url('updateslaborpest')}} method="post">
              @csrf
   ...
   <div  class="d-grid gap-2 d-md-flex justify-content-md-end">
      <a  href="{{route('variable_cost.pesticides.view')}}"button  class="btn btn-success me-md-2">Back</button></a></p>
  ...
  <script>
    ...
    function calculateTotalPesticidesCost() {
        ...
        total_cost_pesticides.value = totalPesticidesCost.toFixed(2); // You can adjust the text of decimal places as needed
    }
