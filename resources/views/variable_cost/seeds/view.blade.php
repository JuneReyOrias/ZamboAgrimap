                                ...
                                <table class="table table-bordered datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table-light">
                                            ...
                                            <td>
                                                <a href="{{route('variable_cost.seeds.seed_edit', $seed->id)}}"
                                                    title="Edit"><button class="btn btn-primary btn-sm"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        Edit</button></a>

                                                <form action="{{ route('variable_cost.seeds.delete', $seed->id) }}"
                                ...
                                <table class="table table-bordered datatable">
                                    ...
                                    @foreach($labors as $labor)
                                        <tr class="table-light">
                                            ...
                                            <td>
                                                  <a href="{{route('variable_cost.labor.labors_edit',  $labor->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                                ...
                                <table class="table table-bordered datatable">
                                    ...
                                    @foreach($fertilizers as $fertilizer)
                                        <tr class="table-light">
                                            ...
                                            <td>
                                                  <a href="{{route('variable_cost.fertilizer.edit',  $fertilizer->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                                    ...
                                    @foreach($pesticides as $pesticide)
                                        <tr class="table-light">
                                            ...
                                            <td>
                                                 ...
                                                 <a href="{{route('variable_cost.pesticides.pest_edit',  $pesticide->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                                    
                                                 <form  action="{{ route('variable_cost.pesticides.delete', $pesticide->id) }}"method="post" accept-charset="UTF-8" style="display:inline">
                                                @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</button>
                                                </form> 
                                    ...
                                    @foreach($transports as $transport)
                                        <tr class="table-light">
                                            ...
                                            <td>
                                                 ...
                                                 <a href="{{route('variable_cost.transport.update',  $transport->id)}}" title="Edit "><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
                                    
                                                 <form  action="{{ route('variable_cost.transport.delete', $transport->id) }}"method="post" accept-charset="UTF-8" style="display:inline">
                                                @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" title="Delete " onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</button>
                                                </form> 
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('variable_cost.var_update',  $vartotal->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
