...
<div class="page-content">
      ...
      <div class="col-md-12 grid-margin">
        <div class="card">
          ...
          <div class="card-body">
           ...
           <form action{{url('updatesfertilizers')}} method="post">
              @csrf
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control placeholder-text "value="{{$fertilizers->name_of_fertilizer}}" name="name_of_fertilizer" id="validationCustom01" placeholder=" Enter fertilizer name" value="{{ old('name_of_fertilizer') }}" >
                </div>
                  <div class="col-md-3 mb-3">
                    <label class="form-expand" for="type_of_fertilizer">Type of Fertilizer:</label>
                    <input type="text" class="form-control placeholder-text @error('type_of_fertilizer') is-invalid @enderror"value="{{$fertilizers->type_of_fertilizer}}" name="type_of_fertilizer" id="validationCustom01" placeholder="Enter type fertilizer" value="{{ old('type_of_fertilizer') }}" >
                 
                  </div>
               
                <div class="col-md-3 mb-3">
                  <label class="form-expand" for="no_ofsacks">No. of Sacks:</label>
                  <input type="text" class="form-control placeholder-text @error('no_ofsacks') is-invalid @enderror" name="no_ofsacks"value="{{$fertilizers->no_ofsacks}}" id="no_ofsacks" placeholder="Enter no of sacks" value="{{ old('no_ofsacks') }}" >
                  @error('no_ofsacks')
              ...
              @enderror
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control placeholder-text @error('unitprice_per_sacks') is-invalid @enderror" name="unitprice_per_sacks"value="{{$fertilizers->unitprice_per_sacks}}" id="unitprice_per_sacks" placeholder="Enter unit price/sacks" value="{{ old('unitprice_per_sacks') }}" >
              ...
              @enderror
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control placeholder-text @error('total_cost_fertilizers') is-invalid @enderror" name="total_cost_fertilizers"value="{{$fertilizers->total_cost_fertilizers}}" id="total_cost_fertilizers" placeholder="Enter total cost" value="{{ old('total_cost_fertilizers') }}" >
   ...
   <div  class="d-grid gap-2 d-md-flex justify-content-md-end">
      <a  href="{{route('variable_cost.fertilizer.view')}}"button  class="btn btn-success me-md-2">Back</button></a></p>
