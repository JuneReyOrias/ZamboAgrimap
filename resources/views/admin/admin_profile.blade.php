    ...
    <div class="row">
      <div class="col">
        <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
          ...
          <h6 class="admin-profile text-center" style="font-size: 20px;">
            Profile
          </h6>
        </nav>
      </div>
      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            @if ($admin->image)
              <img src="/adminimages/{{$admin->image}}" alt="avatar" class="rounded-circle img-fluid" style="width: 150px; height: 140px;">
            @else
              <img src="/upload/profile.jpg" alt="default avatar" class="rounded-circle img-fluid" style="width: 150px; height: 140px;">
            @endif
            <h5 class="my-3">{{ $admin->first_name.' '.$admin->last_name}}</h5>
          ...
          <div class="card-body">
            <form action{{ url('update') }} method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="name" autocomplete="off" value="{{$admin->first_name.' '.$admin->last_name}}">
                </div>
              </div>
              <hr>
              <div class="row">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <img class="rounded-circle" name="image" id="showImage" src="/adminimages/{{$admin->image}}" alt="profile">
                </div>
              </div>
              <hr>
