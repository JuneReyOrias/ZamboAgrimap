...
<h4 class="mb-3 mb-md-0">Curuan Rice Farmers Info</h4>
    ...
    <div id="personal_info_section"class="table-section">
        ...
        <div class="table-responsive tab">
            <table  class="table table-bordered datatable">
                ...
                <tbody>
                    @foreach($FarmersData->where('agri_district','curuan') as $personalinformation)
                    ...
                    {{-- <a href="{{ route('agent.curuan.show_personal_info', ['id' => $personalinformation->id]) }}" class="btn btn-primary">Show Details</a> --}}
    ...
    <div id="farm_profile_section" style="display: none;">
        ...
        <div class="table-responsive tab">
            <table  class="table table-bordered datatable">
                ...
                <tbody>
                    @foreach($FarmersData->where('agri_district','curuan') as $farmers)
                        <tr class="table-light">
