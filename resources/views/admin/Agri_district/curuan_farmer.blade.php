...
<div class="page-content">
    ...
    <div class="dropdown d-flex flex-wrap justify-content-between align-items-center">
      <h4 class="mb-3 mb-md-0 font-weight-bold">Curuan Rice Farmers</h4>
    ...
    <div id="personal_info_section" style="display: none;">
       ...
       <h4 class="mb-3 mb-md-0">Curuan Farmer Reports</h4>
       <br>
     ...
     printWindow.document.write(`
         ...
         <body>
             <div class="container-fluid">
                 <h2>Curuan Farmers Report</h2>
                 <p>This report contains Curuan Farmers Report.</p>
             </div>
             <hr>
     `);
