    ...
    <div class="col-md-12 grid-margin">
      <div class="card border rounded">
        ...
        @endif
          ...
          <h6 class="card-title"><span>I.</span>Create Fisheries Category</h6>

          <br>
       <br>
          <form action{{url('fisheries_categorys')}} method="post">
            @csrf
            <div class="row mb-3">
              ...
              <div class="col-md-3 mb-3">
                <label class="form-expand" for="fisheries_category_name"style="font-size:11px;">Fisheries Category Name:</label>
                <input type="text" class="form-control placeholder-text @error('fisheries_category_name') is-invalid @enderror" name="fisheries_category_name" id="validationCustom01" placeholder="Enter fisheries category name" value="{{ old('fisheries_category_name') }}" >
                @error('fisheries_category_name')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
              <div class="col-md-3 mb-3">
                <label class="form-expand" for="fisheries_description">Description:</label>
                <input type="text" class="form-control placeholder-text @error('fisheries_description') is-invalid @enderror" name="fisheries_description" id="validationCustom01" placeholder="Enter description" value="{{ old('cat_descript') }}" >
                @error('fisheries_description')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
              </div>
    ...
    <div class="col-md-12 grid-margin">
      <div class="card border rounded">
        <div class="card-body">
          ...
          <h4 class="mb-3 mb-md-0">Fisheries Category</h4>
            <br>
...
{{--                          
              ...
              @else
              <tr>
                  <td class="text-center" colspan="5">Fisheries Category not found</td>
              </tr>
          @endif
              </tbody>
          </table>
